...
class BroadcastManager:
    ...
    def load_data(self) -> dict:
        ...
        try:
            with open(VOTES_DB_FILE) as file:
                return json.load(file)
        except (FileNotFoundError, json.JSONDecodeError):
            return {"broadcasts": {}, "votes": {}, "stats": {}}
    ...
    def get_vote_stats(self, broadcast_id: str) -> dict:
        ...
        return {"yes": yes_count, "no": no_count, "total": len(votes)}
    ...
    def get_broadcast_history(self) -> list[dict]:
        ...
        return [
            ...
            for bid, b in sorted(
                self.data["broadcasts"].items(), key=lambda x: x[1]["created_at"], reverse=True
            )
        ]
