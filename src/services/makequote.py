...
class QuoteMaker:
    def __init__(self, bot: Bot, config: Optional[QuoteConfig] = None):
        """
    ...
    async def _get_profile_photo(self, user_id: int) -> Optional[Image.Image]:
    ...
    async def create_quote(self, message: Message) -> Optional[io.BytesIO]:
        """
        ...
        try:
            ...
            quote_text = textwrap.shorten(
                quote_text, 
                width=self.config.max_quote_length, 
                placeholder="..."
            )
            ...
            author_name = textwrap.shorten(
                author_name, 
                width=self.config.max_name_length, 
                placeholder="..."
            )
